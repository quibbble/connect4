    ...
    return (
        <div className="flex flex-col items-center my-8 md:my-12">
            <div className="w-full flex flex-col items-center mt-48">
                ...
                <p className="mb-1 font-thin"><span className="title text-2xl font-black text-red-600 mr-1">Connect<span className="text-blue-600">4</span></span> is down for maintenance</p>
            </div>
